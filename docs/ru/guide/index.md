...
Чтобы увидеть Vue Test Utils в действии, [попробовать ускоренный курс](../guide/essentials/a-crash-course.md), где мы создали простое Todo приложение, используя подход "сначала тест, потом реализация".
...
Вы также можете изучить полную [API](/api/).

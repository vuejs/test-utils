...
В этой статье будут представлены два пути для тестирования приложения, используя Vue Router:
...
Тест _наконец-то_ проходит. Великолепно! Однако все это делается вручную для крошечного небольшого приложения. Вот в чем причина использования имитированного роутера - это распространенный подход при тестировании Vue компонентов, используя Vue Test Utils. В этой случае, если ты предпочитаешь использовать настоящий роутер, держите в уме, что каждый тест должен использовать его собственный экземпляр роутера следующим образом:

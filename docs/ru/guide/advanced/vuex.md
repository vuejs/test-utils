...
Vue Test Utils также позволяет вам установить плагины, используя `global.plugins` опцию в `mount`.
...
Без ключа внедрения данные хранилища могут быть просто вставлены в компонент через глобальную `provide` опцию в `mount`. Название внедряемого хранилища должно быть таким же, как название в компоненте т.е. "store". 

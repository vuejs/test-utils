# Migrating from Vue Test Utils 1

A review of changes VTU 1 -> VTU 2, and some code snippets to showcase required modifications. If you encounter a bug or difference in behavior not documented here, please [open an issue](https://github.com/vuejs/vue-test-utils-next/issues/new).
